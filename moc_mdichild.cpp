...
static const char qt_meta_stringdata_MdiChild[] = {
    ...
    "toGraph()\0columns\0setColumnCount(int)\0"
    "rows\0setRowCount(int)\0copy()\0paste()\0"
};

const QMetaObject MdiChild::staticMetaObject = {
    { &QTableWidget::staticMetaObject, qt_meta_stringdata_MdiChild,
...
int MdiChild::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: toGraph(); break;
        case 2: setColumnCount((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: setRowCount((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: copy(); break;
        case 5: paste(); break;
        default: ;
        }
